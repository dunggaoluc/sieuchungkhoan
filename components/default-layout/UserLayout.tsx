  ...
  const _renderContactBar = () => {
    return (
      ...
      >
        ...
        >
          <VStack as='a' href="tel:0788669289">
            <Stack
              sx={{
                alignItems: "center",
        ...
        <Tooltip
          ...
          display={["none", "none", "none", "flex"]}
        >
          <VStack as="a" href="https://zalo.me/0788669289" target="_blank">
            <Stack
              sx={{
                alignItems: "center",
                justifyContent: "center",
        ...
        >
          <VStack
            onClick={() =>
              router.push("/chi-tiet/huong-dan-mo-tai-khoan-chung-khoan")
            }
          >
            <Stack
              sx={{
        ...
        >
          <VStack
            as="a"
            href="https://docs.google.com/forms/d/e/1FAIpQLSfXzbFDNQQvshZ6rI3OdIXWMrfjRXvSv-_UxVWtpdw8HMwolQ/viewform?fbclid=IwAR0PJzFEV6nl3OkH1pq7VG0r82tjvW_shVo0aJoZNf56fMJBvQ8rbIKVY2w_aem_AYAO6i8zyY0vIHYywsUFSStA_KUc4of6vNdPhL_OjummvRxbop70s9TsXuVTWwuPOWc"
            target="_blank"
          >
            <Stack
              sx={{
