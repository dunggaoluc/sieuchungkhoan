const initFullProps = {
  ...
  toolbar:
    "fullscreen preview print | undo redo | sizeselect | fontselect |  fontsizeselect| bold italic backcolor |  \
     ...
     bullist numlist outdent indent | removeformat | restoredraft wordcount | link image |undo redo ",
  plugins: [
    "wordcount ",
    "link print ",
    "preview fullscreen",
  ...
  // mages_upload_handler: function (blobInfo: any, success: any, failure: any) {
  //   setTimeout(function () {
